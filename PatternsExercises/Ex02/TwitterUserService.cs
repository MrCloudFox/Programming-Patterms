...
{
    public class TwitterUserService : GeneralPartOfGetUserInfo
    {
        ...
        {
            var userName = GetName(pageUrl);
            var userId = GetUserId(userName);

            return GetUser(userName, userId.ToString(), GetFriends(userId));
        }


        private UserInfo[] GetFriends(long userId)
        {
        ...
        //protected override string GetName(string pageUrl)
